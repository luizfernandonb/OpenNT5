    ...
    )
{
    ...
    RmvAllocateRemovableMedia(UserLoggedOn, LogonSid);
    ...
    )
{
    ...
    if (TokenTypeValue == TokenPrimary) {
        if (DuplicateTokenEx(
            Token,
            STANDARD_RIGHTS_READ | TOKEN_IMPERSONATE | TOKEN_QUERY,
            NULL,
