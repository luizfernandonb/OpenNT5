...
#include "sysclock.h"
#include "appdefs.h"
// you need to run bcz on the entire oobe folder to fix these header errors. -chaziz 7/12/2023
#include "obshel.h"
#include "obcomm.h"
// this file doesn't exist and was only added by misha in the decompile. -chaziz 7/12/2023
...
static const CHAR cszRegisterDeviceNotification[] = "RegisterDeviceNotificationA";
static const CHAR cszUnregisterDeviceNotification[] = "UnregisterDeviceNotification";
...
public: // methods
    ...
    void Set2ndInstance(BOOL b2ndInstance)
    {
        m_bSecondInstance = b2ndInstance;
        return;
    }
